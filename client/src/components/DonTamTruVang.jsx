...
const URL = "http://localhost:8080/api/temporary-absence";
const TABLE_HEAD = ["Xác nhận", "Người gửi", "Nơi đến", "Lý do", "Từ ngày", "Đến ngày"];
...
export default function DonTamVangTable() {
    ...
    return (
        ...
        <table className="w-full min-w-max table-auto text-left">
            ...
            <tbody>
            {data.map(({personId, Destination, Reason, StartDate, EndDate, check}, index) => {
