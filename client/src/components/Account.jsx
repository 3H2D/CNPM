...
export default function Account() {
    ...
    const { id } = useParams();
    if(id == 0 || id === undefined) return <h1 className="text-3xl font-semibold text-blue-gray-700">Tài khoản <span className="text-blue-500">Admin</span></h1>;
